...
const sttaddr = "0xE5F890B1a48760bd20AAb8e20AEcc7216b7eF211";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xE5F890B1a48760bd20AAb8e20AEcc7216b7eF211";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xE5F890B1a48760bd20AAb8e20AEcc7216b7eF2113',
          'symbol': 'Yeetoshi',
          'decimals': '18',
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://yeetoshi.com/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x3aCe15cc1E245df28c421D6f027b939f774aa035";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "Stock up Yeetoshi's with BNB";
  }
}, 1000);